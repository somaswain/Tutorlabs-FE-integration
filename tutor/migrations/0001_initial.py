# Generated by Django 3.1.4 on 2021-02-06 15:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='class',
            name='applicants',
            field=models.ManyToManyField(blank=True, related_name='applications', to='tutor.User'),
        ),
        migrations.AddField(
            model_name='class',
            name='hired',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='hired', to='tutor.user'),
        ),
        migrations.AddField(
            model_name='class',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tutor.user'),
        ),
        migrations.CreateModel(
            name='city',
            fields=[
